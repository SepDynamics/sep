...
namespace sep
{
    namespace workbench
    {
        ...
        glm::vec3 MemoryGardenDemo::calculateNodePosition(float coherence)
        {
            ...
            return glm::vec3(radius * std::cos(angle), 0.0f, radius * std::sin(angle));
        }
        ...
        void MemoryGardenDemo::cleanup() { nodes_.clear(); }
        ...
        void MemoryGardenDemo::handleMouse(int x, int y, int button)
        {
