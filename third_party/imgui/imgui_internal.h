...
static inline float  ImRound64(float f)                                         { return (float)std::lround(f); }
...
struct IMGUI_API ImGuiInputTextDeactivatedState
{
    ...
    ImGuiInputTextDeactivatedState() = default;
...
struct IMGUI_API ImGuiErrorRecoveryState
{
    ...
    ImGuiErrorRecoveryState() = default;
};
...
struct IMGUI_API ImGuiTypingSelectState
{
    ...
    ImGuiTypingSelectState() = default;
