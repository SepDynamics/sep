...
public:
  ...
  unsigned int GetWindowSize(const std::string &client_id, Priority priority) const override;
...
private:
  ...
  using ClientMap = tbb::concurrent_hash_map<std::string, std::unique_ptr<ClientData>>;
  ClientMap clients_;
