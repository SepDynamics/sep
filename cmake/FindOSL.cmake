...
# Check if we're using Cycles' OSL
if(EXISTS "${CMAKE_SOURCE_DIR}/extern/cycles/lib")
  set(_cycles_lib_dir "${CMAKE_SOURCE_DIR}/extern/cycles/lib")
  if(EXISTS "${_cycles_lib_dir}/osl")
    set(OSL_ROOT_DIR "${_cycles_lib_dir}/osl")
  endif()
endif()
...
get_filename_component(OSL_SHADER_HINT ${OSL_SHADER_HINT}/../ ABSOLUTE)
