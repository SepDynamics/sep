...
// Forward declaration to avoid pulling in Cycles dependencies
namespace sep { namespace blender { namespace ccl { class CyclesRenderer; } } }
#endif
#include <iostream>
#include <memory>
...
int main(int argc, char** argv) {
    ...
    // Headless server does not instantiate a renderer
