...
namespace sep
{
    namespace api
    {
        ...
        public:
            ...
            virtual std::unique_ptr<::sep::api::HttpResponse> makeJsonResponse(int code,
                                                                   const std::string &message) = 0;
            virtual std::string handleError(const std::string &message, int code) = 0;
            virtual void logRequest(const ::sep::api::HttpRequest &req, int code, const std::string &body,
                                    int64_t duration) = 0;
        };
        ...
        public:
             ...
             */
            void updateConfig(const ::sep::api::AuthConfig &new_config);

            // Server interface implementation
            std::mutex &getMetricsMutex() override;
            ServerMetrics &getModifiableMetrics() override;
            std::unique_ptr<::sep::api::HttpResponse> makeJsonResponse(int code,
        ...
        private:
            ...
            /**
             * @brief Modulate response detail based on coherence metrics (extract coherence from
             * JSON)
            ...
            // Configuration
            ::sep::api::AuthConfig config_;

            // Logging
            std::shared_ptr<spdlog::logger> logger_;

            // Crow application
            std::unique_ptr<::crow::Crow<::sep::api::RateLimitMiddleware, ::sep::api::AuthMiddleware>> app_;
            ...
            // Metrics
            ::sep::api::HealthMetrics metrics_;
