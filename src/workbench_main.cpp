...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Begin("SEP Workbench", nullptr, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
        ...
        ImGui::Separator();
        ImGui::Text("Note: Demo functionality is currently disabled due to GLEW initialization issues.");
