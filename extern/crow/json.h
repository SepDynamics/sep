...
struct r_string
{
    ...
    r_string(r_string&& r) noexcept
    {
        *this = r;
    }

    r_string& operator=(r_string&& r) noexcept
    {
        s_     = r.s_;
        e_     = r.e_;
        owned_ = r.owned_;
...
public:
    ...
    rvalue(type t, char* s, char* e) noexcept
        : start_{s}, end_{e}, key_{}, l_{nullptr}, lsize_{0}, lremain_{0}, t_{t}, nt_{num_type::Null}, option_{0}
    {
        determine_num_type();
    }
    ...
    explicit operator std::string() const
    {
        ...
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"json type container"});
            return "";
        }
#endif
        switch (t())
    ...
    type t() const
    {
        ...
        if (option_ & error_bit)
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"invalid json object"});
            return type::Null;
        }
#endif
        return t_;
    ...
    num_type nt() const
    {
        ...
        if (option_ & error_bit)
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"invalid json object"});
            return num_type::Unsigned_integer;
        }
#endif
        return nt_;
    }
    ...
    int64_t i() const
    {
        ...
        switch (t())
        {
            ...
            default:
                ...
                sep::crow::error::log(sep::crow::error::Code::InvalidJson, sep::shim::string(msg.c_str()));
                return 0;
        }
#endif
        return utility::lexical_cast<int64_t>(start_, end_ - start_);
    ...
    uint64_t u() const
    {
        ...
        switch (t())
        {
            ...
            default: {
                const std::string msg = std::string("expected number, got: ") + get_type_str(t());
                sep::crow::error::log(sep::crow::error::Code::InvalidJson, sep::shim::string(msg.c_str()));
            }
                return 0;
        }
    ...
    double d() const
    {
        ...
        if (t() != type::Number)
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"value is not number"});
            return 0.0;
        }
#endif
    ...
    bool b() const
    {
        ...
        if (t() != type::True && t() != type::False)
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"value is not boolean"});
            return false;
        }
#endif
        return t() == type::True;
    ...
    detail::r_string s() const
    {
        ...
        if (t() != type::String)
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"value is not string"});
            return detail::r_string{nullptr, nullptr};
        }
#endif
        unescape();
    ...
    std::vector<rvalue> lo() const
    {
        ...
        if (t() != type::Object && t() != type::List)
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidJson,
                sep::shim::string{"value is not a container"});
            return {};
        }
#endif
            ...
            while (head != end_)
            {
                if (*head == '\\')
                {
                    switch (*++head)
                    {
                        ...
                        break;
                        default:
                            CROW_LOG_ERROR << "Unknown escape sequence: " << *head;
                            break;
                    }
                }
                else
    ...
    rvalue* begin() const
    {
        ...
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidContainer,
                sep::shim::string{"value is not a container"});
            return nullptr;
        }
#else
        if (t() != type::Object && t() != type::List)
            CROW_RAISE("value is not a container");
#endif
        return l_.get();
    }
    rvalue* end() const
    ...
    const rvalue& operator[](int index) const
    {
        ...
        {
            sep::crow::error::log(
                sep::crow::error::Code::InvalidList,
                sep::shim::string{"value is not a list"});
            return nullValue;
        }
        if (index >= static_cast<int>(lsize_) || index < 0)
        {
            sep::crow::error::log(
                sep::crow::error::Code::IndexOutOfBounds,
                sep::shim::string{"list out of bound"});
            return nullValue;
        }
#else
        if (t() != type::List)
            CROW_RAISE("value is not a list");
        if (index >= static_cast<int>(lsize_) || index < 0)
            CROW_RAISE("list out of bound");
#endif
        return l_[index];
    }
    ...
    const rvalue& operator[](const std::string& str) const
    {
        ...
        {
            sep::crow::error::log(
                sep::crow::error::Code::NotObject,
                sep::shim::string{"value is not an object"});
            static rvalue nullValue;
            return nullValue;
        }
#else
        if (t() != type::Object)
            CROW_RAISE("value is not an object");
#endif
        struct Pred
        {
            bool operator()(const rvalue& l, const rvalue& r) const
        ...
        if (it != end() && it->key_ == str)
            return *it;
#ifdef CROW_JSON_NO_ERROR_CHECK
        static rvalue nullValue;
        sep::crow::error::log(
            sep::crow::error::Code::KeyNotFound,
            sep::shim::string{(std::string("cannot find key: ") + str).c_str()});
        return nullValue;
#else
        CROW_RAISE("cannot find key: " + str);
#endif
    }
        ...
        switch (r.t_)
        {
            ...
            case type::Number: {
                switch (r.nt())
                {
                    ...
                    case num_type::Null:
                        sep::crow::error::log(
                            sep::crow::error::Code::InvalidNumberState,
                            sep::shim::string{"Number with num_type Null"});
                        os << 0;
                        CROW_RAISE("Number with num_type Null");
                }
            }
            break;
            case type::String:
...
// Crow upstream does not enforce standard-layout for rvalue; assertions removed
namespace detail {}
    ...
    struct Parser
    {
            ...
            while (CROW_LIKELY(state != Invalid))
            {
                switch (*data)
                {
                    ...
                    case 'E':
                        ...
                        break;
                    default:
                        if (CROW_LIKELY(state == NumberParsingState::ZeroFirst || state == NumberParsingState::Digits
                                        || state == NumberParsingState::DigitsAfterPoints
                                        || state == NumberParsingState::DigitsAfterE))
        ...
        rvalue decode_object(unsigned depth)
        {
            ...
            while (1)
            {
                ...
                // Idea retained from upstream; no measurable bottleneck observed
                // so this optimization is postponed.
                auto key = t.s();
...
/// Write means this class is used to primarily assemble JSON objects using keys and values and
/// export those into a string.
...
private:
    ...
    public:
        ...
        explicit constexpr number(float value) noexcept : d(static_cast<double>(value)) {}
...
public:
    ...
    wvalue(std::uint8_t value)
        ...
        , num(static_cast<std::uint64_t>(value))
    {}
    ...
    wvalue(std::int8_t value)
        ...
        , num(static_cast<std::int64_t>(value))
    {}
    ...
    wvalue(wvalue&& r) noexcept : returnable("application/json")
    {
        *this = std::move(r);
    }
    ...
    wvalue& operator=(float value)
    {
        reset();
        t_    = type::Number;
        num.d = static_cast<double>(value);
        nt    = num_type::Floating_point;
        return *this;
    }
    ...
    std::string
    execute(std::string txt = "") const  // Not using reference because it cannot be used with a default rvalue
    {
        if (t_ != type::Function)
            return "";
        return f(txt);
...
private:
    ...
    inline void
    dump_indentation_part(std::string& out, const int indent, const char separator, const int indent_level) const
    {
        out.push_back('\n');
        out.append(indent_level * indent, separator);
    }

    inline void dump_internal(const wvalue& v,
                              std::string&  out,
                              const int     indent,
            ...
            case type::Number: {
                if (v.nt == num_type::Floating_point || v.nt == num_type::Double_precision_floating_point)
                {
...
#else
                        (void)snprintf(outbuf, sizeof(outbuf), "%.*g", DECIMAL_DIG, v.num.d);
#endif
                    }
                    else
                    {
...
#else
                        (void)snprintf(outbuf, sizeof(outbuf), "%f", v.num.d);
#endif
                    }
                    char* p                    = outbuf;
                    ...
                    while (*p != '\0')
                    {
                        ...
                        switch (f_state)
                        {
                            case start:  // Loop and lookahead until a decimal point is found
                                ...
                                {
                                    char fch = *(p + 1);
                                    // if the first character is 0, leave it be (this is so that "1.00000" becomes
                                    // "1.0" and not "1.")
                                    if (fch == '0')
                                        p++;
                                    f_state = decp;
                            ...
                            case decp:  // Loop until a 0 is found, if found, record its position
                                ...
                                p++;
                                break;
                            case zero:  // if a non 0 is found (e.g. 1.00004) remove the earlier recorded 0
                                        // position and look for more trailing 0s
                                if (ch != '0')
                                {
                    ...
                    if (pos_first_trailing_0
                        != nullptr)  // if any trailing 0s are found, terminate the string where they begin
