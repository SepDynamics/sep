...
// defines a richer configuration, but the memory manager only requires a
// few fields. Provide a lightweight struct here so the stub configuration
// manager and related tests compile without pulling in the full quantum
// stack.
