...
private:
    ...
    using CoherenceMap =
        tbb::concurrent_hash_map<std::string, QuantumCoherenceManager::PatternCoherenceData>;
...
std::vector<QuantumCoherenceManager::TierMigration> QuantumCoherenceManager::optimizeMemoryLayout()
{
