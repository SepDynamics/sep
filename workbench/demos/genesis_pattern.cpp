...
namespace sep
{
    namespace workbench
    {
        ...
        void GenesisPatternDemo::initializePatterns()
        {
            ...
            initial_state.dimensions = {genesis_config.initial_pattern.dimensions[0],
        ...
        void GenesisPatternDemo::evolvePatterns(float dt)
        {
            ...
            auto result = pattern_processor_->evolvePatterns(
                dt * evolution_rate_ * genesis_config.evolution.rate_multiplier);
