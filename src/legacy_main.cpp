...
void registerDemos()
{
    ...
    demo_manager.registerDemo("genesis", []() { return std::make_unique<GenesisPatternDemo>(); });
    demo_manager.registerDemo("audio", []() { return std::make_unique<AudioVisualizerDemo>(); });
    demo_manager.registerDemo("memory", []() { return std::make_unique<MemoryGardenDemo>(); });
    demo_manager.registerDemo("annealing", []() { return std::make_unique<AnnealingDemo>(); });
    demo_manager.registerDemo("drug_opt", []() { return std::make_unique<DrugOptimizerDemo>(); });
